...
namespace exe_backend.Contract.Exceptions.Middleware;
...
public class ExceptionHandlingMiddleware : IMiddleware
{
    ...
    private static IReadOnlyCollection<Exceptions.ValidationError> GetErrors(Exception exception)
    {
        IReadOnlyCollection<Exceptions.ValidationError> errors = null;
